...
import ombreProfileImg from "../images/ombre_profile_img.jpg";
        ...
        <div className="main-navbar">
          <Grid container direction="row" justify="space-around" alignItems="center">
            <div className="navbar-image">
              <img alt="instagram" className="insta-image" src={instaLogo} />
            </div>
            <div className="navbar-search">
              <input type="text" name="searchuser" className="searchbar" placeholder="Search" />
            </div>
            <div className="navbar-logos">
              ...
              <div className="small-profile">
                ...
                <img src={ombreProfileImg} className="small-profile-img" alt="small profile" />
              </div>
            </div>
          </Grid>
        </div>
